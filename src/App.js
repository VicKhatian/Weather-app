    ...
    <div className="app">
      ...
      <div className="main">
        <div className="top">
          ...
          <h2 className="info">
            Feels like {Math.round(data.current.feels_like - 273.15)}°C
          </h2>
          <h2 className="info">Wind speed {data.current.wind_speed}mph</h2>
          <h2 className="info">Humidity {data.current.humidity}%</h2>
        </div>
